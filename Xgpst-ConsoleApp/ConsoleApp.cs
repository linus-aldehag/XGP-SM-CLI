    ...
    public class ConsoleApp
    {
        ...
        private EditOperationResult? HandleEditMode()
        {
            ...
            if (replacements.Any())
            {
                ...
                var replaced = replacements.Values.Count(x => x.ReplacementFile != null);
                var removed = replacements.Values.Count(x => x.ReplacementFile == null);
                return new EditOperationResult(replaced, removed);
            }
            else return null;
        }
